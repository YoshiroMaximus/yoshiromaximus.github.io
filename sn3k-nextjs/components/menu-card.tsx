...
export function MenuCard() {
  return (
    <div className="menu-card bg-white/70 dark:bg-slate-800/70 p-8 rounded-2xl shadow-lg max-w-md w-full mx-4 border border-gray-200 dark:border-gray-700">
      ...
      <div className="menu-links flex flex-col space-y-3">
        <Link
          href="/mb/dnd"
